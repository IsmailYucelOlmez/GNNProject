...
def get_model_predictions(payload):
    ...
    if option == "REGISTRY":
        ...
        #client = MlflowClient()
        #client.create_registered_model("HIV2")
        
        model_name = "HIV-Inhibitor"
        stage = "Staging"
        model_version=1      
        logged_model = 'runs:/87d494ec19de4f1083358a96261435d2/model'
        http_model_uri="http://127.0.0.1:5000/#/models/HIV-Inhibitor/versions/1"
        extra_conf={}
